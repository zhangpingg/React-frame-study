...
const HooksStudy = lazy(() => import('pages/hooks-study'));
...
const routeList: PartialRouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'antd/index',
        element: <WrapperRouteComponent element={<Antd />} titleId="title.account" />
      },
      {
        path: 'hooks/index',
        element: <WrapperRouteComponent element={<Hooks />} titleId="title.account" />
      },
      {
        path: 'frame/index',
        element: <WrapperRouteComponent element={<Frame />} titleId="title.account" />
      },
      {
        path: 'echarts/index',
        element: <WrapperRouteComponent element={<Echarts />} titleId="title.account" />
      },
      {
        path: 'hooksStudy/index',
        element: <WrapperRouteComponent element={<HooksStudy />} titleId="title.account" />
      },
